...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('update_team_emoji')
        .setDescription('Add emoji for a team')
    ...
    async execute(interaction) {
        ...
        await interaction.reply(`Adding ${emoji} ...`);
        ...
        team_json['emoji'] = emoji;
        MongoHelper.update_team(team_json);
        await interaction.editReply(`Added ${emoji} for ${team_json['team_name']}`);
    },
