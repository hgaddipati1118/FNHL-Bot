...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('breakaway')
        .setDescription('Put in breakaway shot number')
    ...
    async execute(interaction) {
        ...
        if (game_json['game_info']['state'] != 'breakaway') {
            ...
            await interaction.channel.send({ embeds: [Run_Play.run_breakaway(game_json, helper_methods.convert_num(shot_number))] });
